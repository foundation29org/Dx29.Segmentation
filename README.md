...
This project is used to divide a text into paragraphs, lines, sections,… 
...
>- src folder: This is made up of one folder: Dx29.Segmentation, which contains the source code of the project. The latter contains: 
...
>- POST request
>- Query paramenters: 
>>- lan: Select language for the results from the list of available languages: en or es
>- URL: http://127.0.0.1:8080/api/v1/document/segmentation?lan=<language>
